# World regions according to the World Bank - Data package

This data package contains the data that powers the chart ["World regions according to the World Bank"](https://ourworldindata.org/grapher/world-regions-according-to-the-world-bank?v=1&csvType=full&useColumnShortNames=false) on the Our World in Data website. It was downloaded on October 27, 2025.
